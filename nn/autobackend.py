...
from tbknet.yolo.utils import LINUX, LOGGER, ROOT, yaml_load
from tbknet.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from tbknet.yolo.utils.downloads import attempt_download_asset, is_url
from tbknet.yolo.utils.ops import xywh2xyxy
...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
        ...
        if nn_module:
            ...
            from tbknet.nn.tasks import attempt_load_weights
            ...
            from tbknet.yolo.engine.exporter import gd_outputs
            ...
            from tbknet.yolo.engine.exporter import export_formats
