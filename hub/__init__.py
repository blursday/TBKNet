...
from tbknet.hub.auth import Auth
from tbknet.hub.utils import PREFIX
from tbknet.yolo.utils import LOGGER, SETTINGS, USER_CONFIG_DIR, yaml_save
...
def start(key=''):
    ...
    LOGGER.warning(f"""
WARNING ⚠️ tbknet.start() is deprecated after 8.0.60. Updated usage to train Ultralytics HUB models is:

from tbknet import YOLO, hub
