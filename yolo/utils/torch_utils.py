...
from tbknet.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
...
def model_info(model, detailed=False, verbose=True, imgsz=640):
    ...
    fs = f', {flops:.12f} GFLOPs' if flops else ''
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Usage:
        from pathlib import Path
        from tbknet.yolo.utils.torch_utils import strip_optimizer
