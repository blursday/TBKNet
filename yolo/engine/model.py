...
from tbknet import yolo  # noqa
from tbknet.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel,
                             attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
from tbknet.yolo.cfg import get_cfg
from tbknet.yolo.engine.exporter import Exporter
from tbknet.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, ROOT, callbacks,
                               is_git_dir, yaml_load)
from tbknet.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from tbknet.yolo.utils.downloads import GITHUB_ASSET_STEMS
from tbknet.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[tbknet.yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(tbknet.yolo.engine.results.Results): The prediction results.
    """
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None) -> None:
        ...
        if self.is_hub_model(model):
            from tbknet.hub.session import HUBTrainingSession
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('tbknet')) and any(
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        Returns:
            (List[tbknet.yolo.engine.results.Results]): The tracking results.

        """
        if not hasattr(self.predictor, 'trackers'):
            from tbknet.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from tbknet.yolo.utils.benchmarks import benchmark
    ...
    def tune(self,
        ...
        try:
            from tbknet.yolo.utils.tuner import (ASHAScheduler, RunConfig, WandbLoggerCallback, default_space,
